...
RSpec.describe User, type: :model do
  ...
  describe '#create' do
    ...
    it "password_blank_error" do
      @user.password = nil
      @user.valid?
      expect(@user.errors.full_messages).to include("Password can't be blank", "Password is too short (minimum is 6 characters)", "Password confirmation doesn't match Password")
    end
    ...
    it "password_confirmation_blank_error" do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include("Password confirmation can't be blank", "Password confirmation is too short (minimum is 6 characters)")
    end

class User < ApplicationRecord
	...
	validates :email, {presence: true, uniqueness: true, format: { with: URI::MailTo::EMAIL_REGEXP, message: "must be valid" }, on:[:create, :update_email]}
	...
	def wrap_json_user
		return self.as_json(methods: :hashid, except:[:id, :password_digest, :created_at, :updated_at])
	end

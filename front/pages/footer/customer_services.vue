    ...
    <v-row>
      <v-col cols="8" offset-md="2">
        <div class="mt-6" justify="center">
          ...
          <p>
            You are entitled to cancel Your Order within 14 days without giving any reason for doing
            so.
          </p>
          <p>
          ...
          <p>
            ...
            returned Goods. We will use the same means of payment as You used for the Order, and You
          ...
          <p>
            ...
            the Goods at the following address:
          </p>
          <p>1-1-1 Shibuya, Shibuya City, Tokyo Prefecture, Japan</p>
          <p>
          ...
          <p>
            ...
            shipped to themselves to give it to You later, We will send the refund to the gift
            giver.
          </p>
          <h2>Contact Us</h2>

    ...
    <v-row>
      <v-col cols="8" offset-md="2">
        <div class="mt-6" justify="center">
          ...
          <ul>
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to service@cf.com.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to service@cf.com, accessible from <a href="http://monstercoffee.com" rel="external nofollow noopener" target="_blank">http://monstercoffee.com</a></p>
            </li>
            <li>
